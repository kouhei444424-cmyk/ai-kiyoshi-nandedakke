...
for (const [index, html] of [articleHtml, speedingArticleHtml, thirdArticleHtml, fourthArticleHtml].entries()) {
  if (
...
console.log(
  "Build verification passed: 4 anonymous articles, view counters, sponsored adult links and sitemap.",
);
